...
function seedIfEmpty() {
  ...
  seedCollectionIfEmpty("saasImplementationMilestones");
  seedCollectionIfEmpty("saasSuccessActions");
  seedCollectionIfEmpty("saasRiskPlaybooks");
  seedCollectionIfEmpty("saasTenantCohorts");
