const seedData = {
  ...
  saasAdminActivity: [
    {
      ...
      detail: "Betaallink en opvolging zijn beschikbaar in abonnementsfacturatie.",
      status: "Nieuw",
      priority: "Hoog",
  ...
  saasImplementationMilestones: [
    ...
    },
    {
      ...
      tenantId: "tenant-de-linde",
      phase: "AI",
      label: "AI-afspraken go-live check",
      owner: "Praktijkhouder",
      status: "Open",
      dueAt: "08/07/2026",
      completedAt: null,
  ...
  saasRiskPlaybooks: [
    {
      ...
      actionDetail: "Controleer open abonnementsfacturen, bevestig Bancontact/Wero en stem volgende betaalopvolging af.",
      lastRunAt: null,
      lastRunBy: null,
      runCount: 0
    },
    ...
    },
    {
      ...
      actionDetail: "Maak een duidelijke eigenaar/SLA-update voor de praktijk en koppel de blokkade aan verlenging of module.",
      lastRunAt: null,
      lastRunBy: null,
      runCount: 0
    }
