...
export function generateDraft({ workflow, input, knowledge = [] }) {
  ...
  if (workflow === "note") {
    return [
      ...
      `Bron:\n${source}`,
      "",
      "S: Cliënt rapporteert spanning, slaapklachten of functionele hinder.",
  ...
  if (workflow === "letter") {
    return [
      ...
      "Geachte collega,",
      "",
      "Wij zagen cliënt voor een eerste verkennend contact. De hulpvraag en context worden verder in kaart gebracht. Onderstaande tekst is een concept en vereist inhoudelijke validatie voor verzending.",
      "",
  ...
  return [
    ...
    "Cliënt vraagt begeleiding rond de beschreven klachten. De intake is nog niet volledig gevalideerd, dus ontbrekende context moet eerst worden aangevuld.",
    "",
    "Voorgestelde acties:",
