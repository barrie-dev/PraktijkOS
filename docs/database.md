...
- `records`: collection-based records for team, work queue, intakes, notes, messages, portal invites, documents, AI drafts, integration readiness, ISO evidence packs, SaaS invoices and audit log.
